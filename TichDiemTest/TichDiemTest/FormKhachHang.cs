...
{
    /// <summary>
    // Form thêm/sửa khách hàng - đơn giản, tái sử dụng cho cả 2 trường hợp
    /// </summary>
    public partial class FormKhachHang : Form
    {
        ...
        public FormKhachHang(QuanLyKhachHang ql, KhachHang kh = null)
        {
            ...
            if (!laThemMoi)
            {
                ...
                txtDiem.ReadOnly = true; // Điểm không sửa trực tiếp
        ...
        private void InitializeComponent()
        {
            ...
            this.lblCapBac.Click += new System.EventHandler(this.lblCapBac_Click);
            // 
            // lblNgayDK
            // 
            ...
            this.lblNgayDK.Click += new System.EventHandler(this.lblNgayDK_Click);
            // 
            // btnLuu
            // 
        ...
        private void lblCapBac_Click(object sender, EventArgs e)
        {
        ...
        private void lblNgayDK_Click(object sender, EventArgs e)
        {
